...
import { VscTools, VscAccount, VscHome, VscAdd, VscRepo, VscMention } from "react-icons/vsc";
    ...
    <Navbar collapseOnSelect fixed="top" expand="md" bg="dark" variant="dark">
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav>
            <Nav.Link href="/landing">Home <VscHome /></Nav.Link>
            <Nav.Link href="/newrequest">New Service <VscAdd /></Nav.Link>
